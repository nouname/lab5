...
# Project:  l5.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile l5.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = l51.0.0
DISTDIR = /home/meowbyte/l5/.tmp/l51.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: l5.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents board.h player.h point.h $(DISTDIR)/
	$(COPY_FILE) --parents board.cpp main.cpp player.cpp point.cpp $(DISTDIR)/
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/l5/bin || mkdir -p $(INSTALL_ROOT)/opt/l5/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/l5/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/l5/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/l5/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/l5/bin/ 
